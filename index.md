...
venue: "UChicago Biological Sciences Division"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Nick Knoblauch", "Briana Mittleman", "Zach Miller"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jennifer Blanc", "Jelena Scepanovic", "Grace Hansen", "Esha Bandhopadyay"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["abiddanda@uchicago.edu", "uccarpentries@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:             # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 86179885357 # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
